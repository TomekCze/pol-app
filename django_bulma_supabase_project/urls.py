...
from barbarella_site.views import podsumowanie_view, podsumowanie_zakres, podsumowanie_punkty_view, index_view, weekly_norms_view, scoring_view, tinman_view
